...
//	GPIO_PinRemapConfig(GPIO_PartialRemap2_TIM2, ENABLE);			//将TIM2的引脚部分重映射，具体的映射方案需查看参考手册
//	GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable, ENABLE);		//将JTAG引脚失能，作为普通GPIO引脚使用
	...
	GPIO_InitStructure1.GPIO_Pin = GPIO_Pin_15;		//GPIO_Pin_15;
	...
	TIM_TimeBaseInitStructure.TIM_Prescaler = 4 - 1;				//预分频器，即PSC的值
	...
	TIM_OCInitStructure.TIM_Pulse = 950;								//初始的CCR值
...
{
	if(i==1) GPIO_SetBits(GPIOB,GPIO_Pin_15);
